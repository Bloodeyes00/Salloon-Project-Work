...
class Saloons extends Component {
  ...
  getSaloons = () => {
    let data = {
      ...
      Day: this.props.match.params.date,
    };
                ...
                <div className="static_filters">
                  ...
                  <div className="categories_title_main">
                    ...
                    <div className="listing_categories_filters">
                      {this.props.services.categories &&
                        this.props.services.categories.map((data) => {
                          return (
                            <div className="form-group">
                              <div class="chiller_cb">
                                <input
                                  checked={this.state.filters.Categories.includes(
                                    data._id
                                  )}
                                  onChange={(e) => {
                                    this.changeFilters("Categories", data._id);
                                  }}
                                  id={`myCheckbox${data._id}`}
                                  type="checkbox"
                                />
                                <label for={`myCheckbox${data._id}`}>
                                  {data.title}
                                </label>
                                <span></span>
                              </div>
                        ...
                        >
                          <div className="img_sec_salon">
                            <img
                              ...
                              className="img-fluid"
                            />
                            <div className="image_tag">{/* <p>New</p> */}</div>
                          </div>
