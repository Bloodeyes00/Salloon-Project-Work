...
const StaffDetail = (props) => {
    ...
    const handleShow=()=>{
        ...
        AuthApi.getStaffDetail(data).then((res)=>{
   ...
   AuthApi.getStaffBookingById({Staff_Id:props.match.params.id}).then((res)=>{
       if(res.data.Error==false){
        setAppointments(res.data.Data)
       }
   })
   AuthApi.getAllServices().then((res)=>{
    if(res.data.Error==false){
     setServices(res.data.data)
    }
})

AuthApi.getdesignations().then((res) => {
    if (res.data.Error == false) {
   ...
   const deleteStaff=()=>{
        ...
        //   })
          .then((willDelete) => {
            if (willDelete) {
                AuthApi.admindeletestaff(data).then(res => {
        ...
        <div style={{marginTop:15}}>
            ...
            <div className="adjust_sidebar-manageStaff">
                <div className="staff_det_main">
                    <div className="products_main_title backrarrow_main">
                        <h2 onClick={()=>{history.goBack()}}> <FiChevronLeft />{staff.Name}</h2>
                        <div className="edit_del_stf_btn">
                            <button type="button" className="btn btn-yellow" onClick={handleShow}>Edit Profile</button>
                            <button onClick={deleteStaff} type="button" className="btn btn-danger">Delete Profile</button>
                        </div>
                    </div>
                    <div className="staff_main_img_name">
                         <div className="img_sec_stf">
                         {staff.Photos && staff.Photos.length ?(
                         <img src={`${process.env.REACT_APP_BASE_URL}/${staff.Photos[0]}`} alt="" className="img-fluid" />
                        ...
                        <div className="col-md-12">
                            <div className="serv_stf_section">
                                ...
                                <div className="serv_stf_names">
                                    {staff.Services && staff.Services.map((data)=>{
                                        return(
                                            <h4>{data.Name}</h4>
                                        )
                                    }) }
                    ...
                    <div className="main_timing_stf_det">
                        <div className="row m-0">
                            <div className="col-md-3">
                                ...
                                <div className="serv_stf_names">
                                    {
                                    staff.Time_Slots &&  staff.Time_Slots.map((data)=>{
                                          return(
                                            <h4>{data.day}</h4>
                            ...
                            <div className="row m-0">
                                <div className="col-md-3">
                                    <div className="img_port_sec">
                                            ...
                                            { staff.Photos && staff.Photos.length ? ( <img src={`${process.env.REACT_APP_BASE_URL}/${staff.Photos[0]}`}  alt="" className="img-fluid" />
                                       ):(<img src={noImage} alt="noimage"/>)}
                                ...
                                <div className="col-md-9">
                                    <div className="row">
                                        {
                                            staff.Photos && staff.Photos.map((data)=>{
                                                return(
                                                    <div className="col-md-3">
                                                    <div className="small_port_img">
                                                        {data ? (
                                                        
                                                        <img src={`${process.env.REACT_APP_BASE_URL}/${data}`} alt="" className="img-fluid" />
                                                        ):(<img src={noImage} alt="noimage"/>)}
                                                        </div>
                                                </div>
                                                )
                                                ...
                                                return(
                                                    ...
                                                    <div className="content_tdy_app_main">
                                                        ...
                                                        <div className="align_tdy_app">
                                                            ...
                                                            <div className="content_tdy_app">
                                                                <h4>Date</h4>
                                                                <h3>{moment(data.Appointment_Date).format("DD MMM YYYY")}</h3>
                                                            </div>
                                                            <div className="content_tdy_app">
                                                                <h4>Time</h4>
                                                                <h3>11:00 - 12:00</h3>
            ...
            <Modal show={show} onHide={handleClose} className="custom_width_modal">
                ...
                <Modal.Body>
                    ...
                    <Formik
                        initialValues={{ name: staff.Name, service:staffServices,designation:staff.Designation, email: staff.Email, gender:staff.Gender, age: staff.Age, phoneNumber: staff.phoneNumber, day: "", start_time: "", end_time: "", slot_interval: "", slot_time: "", slots: staff.Time_Slots, images: [] }}
                        addSlot={addSlot}
                        onSubmit={(values) => {
                            ...
                            AuthApi.updateStaff(formData).then((res)=>{
