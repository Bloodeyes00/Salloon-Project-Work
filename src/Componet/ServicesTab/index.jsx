          ...
          {this.props.selectionStaff ? (
              ...
              <div className="col-md-8">
                <div className="serv_wizards">
                  <Accordion className="privacyContainer" defaultActiveKey="0">
                    <Card
                      className={`${
                        this.props.activeTab == 1 ? "tabActive" : ""
                      }`}
                    >
                      <Accordion.Toggle as={Card.Header} eventKey={2}>
                        <div
                          ...
                          onClick={() => {
                            this.props.updateTabe({ activeTab: 1 });
                          }}
                        >
                        ...
                        <Card.Body className="adjust_padding">
                          ...
                          <div className="description_collapse">
                            <div className="main_custom_chk_desri">
                              {this.props.reserve_id.Services &&
                                this.props.reserve_id.Services.map(
                                  (data1, i) => {
                                    return (
            ...
            <div className="row m-0">
              <div className="col-md-8">
                <div className="serv_wizards">
                  <Accordion className="privacyContainer" defaultActiveKey="0">
                    {this.props.allData.Services &&
                      this.props.allData.Services.map((data, i) => {
                        return (
                          <Card
                            className={`${
                              this.props.activeTab == i ? "tabActive" : ""
                            }`}
                          >
                            <Accordion.Toggle as={Card.Header} eventKey={2}>
                              <div
                                className="custom_head_collapse"
                                onClick={() => {
                                  this.props.updateTabe({ activeTab: i });
                                }}
                              >
                                <div className="main_services_cards">
                                  <div className="servuces_cards_image">
                                    <div className="collapse_img">
                                      <img
                                        src={`${process.env.REACT_APP_BASE_URL}/${data.Category.Background_Pic}`}
                                        alt=""
                                        className="img-fluid"
                                      />
                                    </div>
