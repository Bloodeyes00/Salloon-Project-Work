                        ...
                        <div className="col-md-8">
                            <div className="serv_wizards">
                                <Accordion className="privacyContainer" defaultActiveKey="0">
                                    {
                                       this.props.allData.Products && this.props.allData.Products.map((data, i) => {
                                            return (
                                                                                ...
                                                                                <div className="checkbox_collapsed">
                                                                                    <div className="custom_ceckbox_description">
                                                                                        <div class="form-group mb-0">
                                                                                            <input
                                                                                            onChange={(e)=>{let dat=this.props.bookingDetail.Products; if(this.props.bookingDetail.Products.some(m=>m._id==data1._id)){dat=this.props.bookingDetail.Products.filter(dd=>dd._id!==data1._id)}else{dat.push({_id:data1._id,Name:data1.Name,Price:data1.Price,Quantity:1})}; this.props.setBookingDetail("Products",dat)}}
                                                                                             checked={products && products.includes(data1._id)}
                                                                                            type="checkbox" id={data1._id} />
